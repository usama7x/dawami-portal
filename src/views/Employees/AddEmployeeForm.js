...
function AddEmployeeForm({ updateEmpList, close }) {
  ...
  const imageUpload = useCallback((imageName, imageDataUrl) => {
                ...
                <GridContainer>
                  <GridItem xs={12} sm={12} md={4}>
                    <div className={classes.customImageContainer}>
                      <img
                        className={classes.customImageType2}
                  ...
                  <GridItem xs={12} sm={12} md={8}>
                    <GridItem xs={12} sm={12} md={12}>
                      <div className={classes.positionRelative}>
                        ...
                        <span
                          className={
                            classes.requiredSign + " " + classes.marginTop30
                          }
                        >
                          *
                        </span>
