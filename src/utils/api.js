...
const host = "https://localhost:44348";
const url = {
...
export const getEmployees = async (empId) => {
  const result = await axios.get(getFullUrl("profile"), {
    params: {
      empId: empId,
    },
    headers: headers,
...
export const getDashboardData = async (orgId) => {
  const result = await axios.get(getFullUrl("dashboard"), {
    params: {
...
export const getCompanyData = async () => {
  const result = await axios.get(getFullUrl("companyProfile"), {
    params: {
      orgId: appCache("orgId"),
    },
    headers: headers,
...
export const getAllTimeZoneData = async () => {
  const result = await axios.get(getFullUrl("timeZone"), {
    headers: headers,
  });
  return result;
};
...
export const getShiftData = async () => {
  const result = await axios.get(getFullUrl("shiftData"), {
    params: {
      orgId: appCache("orgId"),
    },
    headers: headers,
...
export const getLanguageData = async () => {
  const result = await axios.get(getFullUrl("languageList"), {
    headers: headers,
  });
  return result;
};
...
export const updatePassordApi = async (password) => {
  const result = await axios.post(getFullUrl("changePassword"), null, {
    headers: headers,
    params: {
...
export const uploadFile = async (file) => {
  const result = await axios.post(getFullUrl("fileUpload"), file, {
    headers: headers,
  });
  return result;
};
...
export const updateCompanyProfileApi = async (data) => {
  const result = await axios.post(getFullUrl("upadteCompanyProfile"), data, {
    headers: headers,
  });
  return result;
};
...
export const addNewShiftApi = async (data) => {
  const result = await axios.post(getFullUrl("addShift"), data, {
    headers: headers,
  });
  return result;
};
...
export const deleteShiftApi = async (id) => {
  const result = await axios.delete(getFullUrl("deleteShift"), {
    headers: headers,
    params: {
      shiftId: id,
    },
...
export const editShiftApi = async (data) => {
  const result = await axios.post(getFullUrl("editShift"), data, {
    headers: headers,
  });
  return result;
};
...
export const getEmployeeList = async (data) => {
  ...
  const result = await axios.get(getFullUrl("getEmpUrl"), {
    params,
    headers: headers,
  });
  return result;
...
export const getEmployeeReportApi = async () => {
  ...
  const result = await axios.get(getFullUrl("getEmpReport"), {
    params,
    headers: headers,
  });
  return result;
...
export const getAttendanceApi = async (params) => {
  const result = await axios.get(getFullUrl("getAttendanceUrl"), {
    params,
    headers: headers,
  });
  return result;
...
export const addAttendanceApi = async (data) => {
  ...
  const result = await axios.post(getFullUrl("addAttendanceUrl"), params, {
    headers: headers,
  });
  return result;
};
...
export const deleteAttendanceApi = async (attendanceId) => {
  ...
  const result = await axios.delete(getFullUrl("deleteAttendanceUrl"), {
    params,
    headers: headers,
  });
  return result;
...
export const editAttendanceApi = async (attendanceId, data) => {
  ...
  const result = await axios.post(getFullUrl("editAttendanceUrl"), data, {
    headers: headers,
    params,
  });
  return result;
...
export const deleteEmployeeApi = async (id) => {
  const result = await axios.post(getFullUrl("deleteEmployeeUrl"), null, {
    headers: headers,
    params: {
      userId: id,
      isActive: false,
...
export const getOrgUserAttendanceApi = async (startDate, endDate) => {
  ...
  const result = await axios.get(getFullUrl("orgUserAttendance"), {
    params,
    headers: headers,
  });
  return result;
...
export const getAttendanceReportApi = async (startDate, endDate) => {
  ...
  const result = await axios.get(getFullUrl("getReportAttendance"), {
    params,
    headers: headers,
  });
  return result;
...
export const getUserAttendanceExcelApi = async (userId, startDate, endDate) => {
  ...
  const result = await axios.get(getFullUrl("userAttendanceExcelUlr"), {
    params,
    headers: headers,
  });
  return result;
...
export const getOrgUsersSalaryApi = async (startDate, endDate) => {
  ...
  const result = await axios.get(getFullUrl("orgUsersSalaryUrl"), {
    params,
    headers: headers,
  });
  return result;
...
export const getOrgUsersSalaryExcelApi = async (startDate, endDate) => {
  ...
  const result = await axios.get(getFullUrl("orgUsersSalaryExcelUlr"), {
    params,
    headers: headers,
  });
  return result;
